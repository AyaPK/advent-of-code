...
You make a list of the remaining ingredients you could use to finish the recipe (your puzzle input) and their
...
You can only measure ingredients in whole-teaspoon amounts accurately, and you have to be accurate, so
you can reproduce your results in the future. The total score of a cookie can be found by adding up each of the
